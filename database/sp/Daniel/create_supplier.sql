...
BEGIN
    INSERT INTO suppliers (supplier_name, contact_number, is_active, note, created_at, updated_at)
    VALUES (p_supplier_name, p_contact_number, p_is_active, p_note, NOW(), NOW());
