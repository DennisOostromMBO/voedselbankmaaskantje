<nav class="w-full bg-[#2563eb]">
    <div class="container mx-auto px-8 flex flex-col md:flex-row items-center justify-between py-4">
        ...
        <ul class="nav-links flex gap-4 mt-4 md:mt-0">
            ...
            <li><a href="#" class="nav-link flex items-center gap-2 text-white"><i class="fas fa-users"></i> Customers</a></li>
            <li><a href="#" class="nav-link flex items-center gap-2 text-white"><i class="fas fa-box"></i> Food Parcels</a></li>
            <li><a href="#" class="nav-link flex items-center gap-2 text-white"><i class="fas fa-warehouse"></i> Stock</a></li>
            <li><a href="#" class="nav-link flex items-center gap-2 text-white"><i class="fas fa-truck"></i> Suppliers</a></li>
